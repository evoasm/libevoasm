...
evoasm_x64_init() {
  ...
  evoasm_x64_reg_type_bytesizes[EVOASM_X64_REG_TYPE_MM] = 8;
...
evoasm_x64_is_useful_inst(evoasm_x64_inst_id_t inst) {
  switch(inst) {
    ...
    case EVOASM_X64_INST_VAESDEC_XMM_XMM_XMMM128:
    case EVOASM_X64_INST_AESDECLAST_XMM_XMMM128:
    case EVOASM_X64_INST_VAESDECLAST_XMM_XMM_XMMM128:
    case EVOASM_X64_INST_AESENC_XMM_XMMM128:
    case EVOASM_X64_INST_VAESENC_XMM_XMM_XMMM128:
    case EVOASM_X64_INST_AESENCLAST_XMM_XMMM128:
    case EVOASM_X64_INST_VAESENCLAST_XMM_XMM_XMMM128:
    case EVOASM_X64_INST_AESIMC_XMM_XMMM128:
    case EVOASM_X64_INST_VAESIMC_XMM_XMMM128:
    case EVOASM_X64_INST_AESKEYGENASSIST_XMM_XMMM128_IMM8:
    case EVOASM_X64_INST_VAESKEYGENASSIST_XMM_XMMM128_IMM8:
...
evoasm_x64_cpu_state_set(evoasm_x64_cpu_state_t *cpu_state, evoasm_x64_reg_id_t reg, const uint64_t *data,
  ...
  uint64_t *reg_data = evoasm_x64_cpu_state_get_reg_data(cpu_state, reg);
  memcpy(reg_data, data, bytes_len);
