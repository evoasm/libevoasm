...
evoasm_x64_features(uint64_t *features) {
  ...
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG0, EVOASM_X64_REG_A);
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_IMM0, 1);
...

  {
    ...
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG0, EVOASM_X64_REG_DI);
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_IMM0, addr_imm);
    EVOASM_X64_ENC(mov_r64_imm64);

    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG1, EVOASM_X64_REG_D);
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG_BASE, EVOASM_X64_REG_DI);
    EVOASM_X64_ENC(mov_rm32_r32);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_ADDRESS_SIZE);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_REG_BASE);
...

  {
    ...
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG1, EVOASM_X64_REG_C);
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG_BASE, EVOASM_X64_REG_DI);
    EVOASM_X64_ENC(mov_rm32_r32);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_ADDRESS_SIZE);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_REG_BASE);
  ...
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG0, EVOASM_X64_REG_A);
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_IMM0, 7);
  EVOASM_X64_ENC(mov_r32_imm32);

  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG0, EVOASM_X64_REG_C);
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_IMM0, 0);
  EVOASM_X64_ENC(mov_r32_imm32);
...

  {
    ...
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG1, EVOASM_X64_REG_B);
    EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG_BASE, EVOASM_X64_REG_DI);
    EVOASM_X64_ENC(mov_rm32_r32);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_ADDRESS_SIZE);
    EVOASM_X64_PARAM_UNSET(EVOASM_X64_PARAM_REG_BASE);
  ...
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_REG0, EVOASM_X64_REG_A);
  EVOASM_X64_PARAM_SET(EVOASM_X64_PARAM_IMM0, 2147483649);
  EVOASM_X64_ENC(mov_r32_imm32);
  ...
  EVOASM_TRY(enc_failed, evoasm_x64_func_epilog, x64_enc_ctx, &buf, EVOASM_X64_ABI_SYSV);
